...
\begin{doc}{La lumière : une onde électromagnétique}
  ...
  À chaque couleur est associée une radiation de longueur d'onde $\lambda$ (lambda), on appelle ça le \important{spectre électromagnétique.}
  ...
  \begin{importants}    
    ...
    \begin{listePoints}
      ...
      \item \important{Domaine InfraRouge (IR) :} radiation avec une longueur d'onde supérieure à \qty{700}{\nm} et inférieure à \qty{1}{\mm}.
...
\question{
  ...
  Non elles diminuent, on passe de \qty{700}{\nm} (rouge) à \qty{400}{\nm} (violet).
}[2]
...
\begin{doc}{Spectre du rayonnement thermique des corps chauds}
  ...
  Le graphique à droite représente le spectre du rayonnement thermique d'un corps chaud à une température $T = \qty{3000}{\kelvin}$ (kelvin).
  Ce spectre a une intensité maximale $I_{max}$ en $\lambda_{max}$.
  \medskip
...
\question{
  ...
  Il suffit d'ajouter \num{273} à la température en degré Celsius, $T = \qty{37}{\degreeCelsius} = \num{37} + \qty{273}{\kelvin} = \qty{310}{\kelvin}$.
}[1]
...
\correction{
  \begin{boiteColoree}
    On a un maximum à \qty{700}{\nm} pour une température de \qty{4142}{\kelvin},
    et un maximum à \qty{400}{\nm} pour une température de \qty{7250}{\kelvin}.
  \end{boiteColoree}
}
...
\question{
  ...
  On a une longueur d'onde de $\qty{9,35e-6}{\m} = \qty{9,35}{\micro\m}$, soit une onde dans le domaine infrarouge (IR).
}[1]