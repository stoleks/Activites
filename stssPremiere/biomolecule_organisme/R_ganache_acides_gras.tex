...
\begin{doc}{Les oméga 3 et 6}[\label{doc:omega_3_6}]
  \extrait[futurasciences.com]{
...
\begin{doc}{Accumulation de graisse dans le corps humain}[\label{doc:accumulation_graisse}]
  \extrait[wikipedia.fr]{
...
L'équation de la réaction d'hydrolyse est présentée ci-dessous.
\begin{center}  
  \chemname{\chemfig{!\oleineSemiDev}}{Oléine}
  + 3 \chemname{\eau}{A}
  \reaction \chemname{\chemfig{!\glycerolSemiDev}}{B}
...
\question{
  ...
  Un triglycéride est une molécule de glycérol estérifiée avec trois acide gras.\points{1}
}[3]

\pasCorrection{\pagebreak\vspace*{-36pt}}
\question{
  Nommer les molécules désignées par A et B dans l'équation de la réaction d'hydrolyse de l'oléine et donner leur formule brute.
}{
...
\question{
  Entourer et nommer le groupe caractéristique présent dans cette molécule.
}{
...
\question{
  ...
  (1 mole d'oléine $\reaction$ 3 moles d'acide oléique),
  calculer la masse d'acide oléique dans l'huile de palme.
  Comparer avec celle mentionnée dans le tableau du document~\ref{doc:accumulation_graisse}.
  \important{Rappel :} $m = n \times M$.
}{
  ...
  On trouve la même valeur que dans le tableau du document~\ref{doc:accumulation_graisse}, les deux résultats sont cohérents. \points{1}
}[4]
