...
\begin{doc}{Avoir une alimentation équilibrée}
  ...
  \begin{importants}  
    Il faut par ailleurs respecter l'apport énergétique (AE) recommandé par l'agence nationale de la santés, les apports énergétiques doivent venir  :
    \begin{listePoints}
      \item de \num{35} à \qty{40}{\percent} des lipides ;
      \item de \num{10} à \qty{20}{\percent} des protéines ;
      \item de \num{40} à \qty{55}{\percent} des glucides.
    \end{listePoints}
  \end{importants}
\end{doc}
...
\begin{doc}{Valeur énergétique des aliments}
  ...
  Pour calculer la valeur énergétique d'un aliment, il faut faire la somme de l'énergie apportée par les glucides, les lipides et les protéines.
...
\question{
  ...
  \begin{equation*}
    ...
    = \qty{5.04}{\kilo\joule\per\g}
  \end{equation*}
  On calcule de la même façon la valeur énergétique des autres aliments pour \qty{1}{\g} :
  \begin{align*}
    & E_{steak}     = \qty{6.82}{\kilo\joule\per\g} \\
    & E_{mandarine} = \qty{2.25}{\kilo\joule\per\g} \\
    & E_{pain}      = \qty{9.58}{\kilo\joule\per\g} \\
  \end{align*}
}[4]
...
\question{
  ...
  \begin{align*}
    ...
    &= \qty{200}{\g} \times \qty{5.04}{\kilo\joule\per\g} + \qty{110}{\g} \times \qty{6.82}{\kilo\joule\per\g} + \qty{40}{\g} \times \qty{2.25}{\kilo\joule\per\g} + \qty{25}{\g} \times \qty{9.58}{\kilo\joule\per\g} \\
    &= \qty{2088}{\kilo\joule}
  \end{align*}
}[1]
...
\question{
  ...
  \begin{equation*}
    \dfrac {\qty{2088}{\kilo\joule}} {\qty{9614}{\kilo\joule}} = \num{0.22} = \qty{22}{\percent}
  \end{equation*}
}[1]
