...
\begin{doc}{Classification des glucides}{doc:A_classification_glucides}
  ...
  \begin{tikzpicture}
    ...
    \node[rectArrondi= red-200, below right= 0.5cm and 0.2cm of glucides] (poly) {Glucides complexes, polysaccharides, \important[black]{hydrolysables}};
    %%%% Oses
    ...
    %%%% Osides
    \node[rectArrondi= orange-100, below left=  1.5cm and -1.9cm of poly] (disac)   {Disaccharides (2 oses)};
    \node[rectArrondi= orange-100, below right= 1.5cm and -1.9cm of poly] (polysac) {Polysaccharides (n oses)};
    %%
    ...
    %
    \draw[fleche=orange-200] ($(disac) + (0.5, -0.8)$) |- (lactose);
    \draw[fleche=orange-200] ($(disac) + (1, -0.8)$)   |- (maltose);
    \draw[fleche=orange-200] ($(disac) + (1.5, -0.8)$) |- (saccha);
    %
    \draw[fleche=orange-200] ($(polysac) + (-1,-0.8)$)   |- (amidon);
    \draw[fleche=orange-200] ($(polysac) + (-1.5,-0.75)$) |- (glycogene);
  \end{tikzpicture}
  \end{center}
