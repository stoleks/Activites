...
\begin{doc}{Molécules tensioactives}[\label{doc:A_molecule_tensioactive}]
  ...
  \begin{center}
    \begin{tikzpicture}
      %% Choline
      \fill[color=yellow-200] (-6.9,-1.6) circle (0.7); 
      %% Glycérol
      \fill[color=purple-50, rounded corners = 8pt]
        (-1.2, 0) -- (-1.2, -0.75) -- (0, -0.75) -- (0, -1.9) --
        (-3.6, -1.9) -- (-3.6, -0.75) -- (-2.4, -0.75) -- (-2.4, 0) -- cycle;
      %% Phosphate
      \fill[color=orange-150] (-4,-1.6) circle (1.3);
      %% Acides gras
      \fill[color=cyan-200, rounded corners = 8pt]
        (-0.7, -0.65) -- (5.1, -0.65) -- (5.1, 1.6) -- (3, 1.6) --
        (3, 3) -- (0.7, 3) -- (0.7, 0.6) -- (-0.7, 0.6) -- cycle;
      \fill[color=cyan-200, rounded corners = 8pt] (0.7,-0.85) -- (8, -0.85) -- (8, -2) -- (0.7, -2) -- cycle;
      %% Molécule
...
\begin{doc}{Micelles et couches-bilipidiques}
  ...
  Les queues hydrophobes étant repoussées par les molécules d'eau, elles vont s'agglomérer et former des structures où les queues sont isolées de l'eau environnante : \important{les micelles,} avec un intérieur sans eau.
  \smallskip
