...
\begin{doc}{La respiration cellulaire}[\label{doc:A_respiration_cellulaire}]
  \begin{importants}
...
\begin{doc}{L'adénosine triphosphate : une réserve d'énergie pour les cellules}
...
\question{
  ...
  On reconnait des groupes amines (\chemfig{N}) et des groupes hydroxyles (\chemfig{HO}).
}[6]

\question{
  Donner la formule brute de l'ATP.
}{
  La formule brute de l'ATP est \chemfig{C_{10} H_{12} O_{13} N_{5} P_{3}}.
}[1]

\question{
  Calculer la masse molaire de l'ATP.
}{
  La masse molaire de l'ATP est
  \begin{align*}
    \masseMol{ATP} 
    &= 10\masseMol{C} + 12\masseMol{H} + 13\masseMol{O} + 5\masseMol{N} + 3\masseMol{P} \\
    &= (10\times14 + 12\times1,0 + 13\times16 + 5\times14 + 3\times31)\unit{\g\per\mole} \\
    &= \qty{579}{\g\per\mole}
  \end{align*}
}[2]
...
\question{
  ...
  Quand le dioxygène manque, l'adénosine triphosphate est fabriquée dans la filière anaérobie, en plus petite quantité que dans la filière aérobie, et de l'acide lactique est aussi formé.
  C'est cet acide lactique qui est responsable des crampes et des douleurs musculaires.
}[3]

\documentaire
Réaliser une carte mentale qui synthétise les différentes étapes de production, stockage et récupération de l'énergie dans une cellule pendant la respiration.
