...
\vspace*{-32pt}
\titreActivite{Apprentissage et mémorisations}
...
\begin{contexte}
  ...
  Parmi ce flux d'information, notre cerveau va en conserver certaine, c'est le mécanisme de \important{mémorisation.} Il est au cœur de tout apprentissage, manuel ou théorique.
...
\begin{doc}{Les 4 piliers de l'apprentissage}{doc:piliers_apprentissage}
  \qrcodeCote{https://www.youtube.com/watch?v=TJSeinBVUXk}
  ...
  \qrcodeCote{https://www.youtube.com/watch?v=vJG698U2Mvo}(-32pt)
...
\begin{doc}{Le processus de mémorisation}{doc:processus_memorisation}
...
\begin{doc}{Techniques de mémorisation}{doc:techniques_memorisation}
