...
\vspace*{-8pt}
  ...
  Ce document, \important{qui sera ramassé et évalué,} présente les activités et travaux pratiques à réaliser pendant les 3 semaines du chapitre.
...
\begin{multicols}{2}
  \begin{TP}{titre = Les glucides, duree = 1 h, label = glucides}
    \begin{prerequis}
  ...
  \begin{activite}{titre = Les lipides, duree =  1 h, label = lipides}
    \begin{prerequis}
  ...
  \begin{TP}{titre = Les vitamines, duree = 1 h, label = vitamines}
    \begin{prerequis}
      \item Connaître la formule topologique.
      \item Savoir identifier les fonctions alcool et ester.
    \end{prerequis}
    \begin{objectifs}
      \item Définir une vitamine.
      \item Étudier la structure de l'acide ascorbique.
...
\begin{programmeSeance}[nombre = 3, distance = 0 pt]
  \seance
