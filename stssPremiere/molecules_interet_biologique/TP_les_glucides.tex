...
%%%%%
\begin{doc}{Sucres rapides et sucres lents}
  \begin{importants}
...
\begin{doc}{Le glucose et le fructose sous forme linéaire et cyclique}
  \begin{multicols}{2}
  \begin{center}
    \separationBlocs{
      \centering
...
\begin{doc}{Une partie de l'amidon}
  \begin{center}
...
\begin{doc}{Le test de Fehling}[\label{doc:test_fehling}]
...
\mesure
Mettre en œuvre le protocole expérimental du document~\ref{doc:test_fehling} permettant de distinguer des solutions de glucose et de fructose.
