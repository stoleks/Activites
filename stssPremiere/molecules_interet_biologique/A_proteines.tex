...
\begin{doc}{Acides $\mathbf{\alpha}$-aminés}{doc:A7_acides_amines}
  ...
  Parmi ces 22 acides aminés, 8 ne sont pas synthétisés par le corps humain, on dit que ce sont des \important{acides aminés essentiels,} qui doivent être apportés par une alimentation équilibrée.
\end{doc}
...
\begin{doc}{Séquence de 3 acides $\alpha$-aminés dans l'insuline humaine}{doc:A7_insuline_aa}
  \begin{center}
    \chemfig{
      NH_2 !\glycinePoly NH !\isoleucinePoly NH !\valinePoly OH
    }
  \end{center}
\end{doc}
...
\question{
  Entourer et nommer le groupe caractéristique formé au cours de la liaison peptidique.
}{}[1]
