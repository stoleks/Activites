...
%%%%
\question{
  En utilisant les données du document~\ref{doc:A1_masse_molaire}, calculer la masse molaire des trois constituants de la coriandre dont la formule brute est précisée dans le document~\ref{doc:A1_coriandre}.
}{
  \begin{align*}
    \masseMol{H_2O} &=
