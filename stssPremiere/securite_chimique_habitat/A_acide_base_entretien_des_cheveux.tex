...
\begin{doc}{Le modèle de Br\o{}nsted}{doc:A3_modele_bronsted}
  ...
  \exemple
  \texteTrouLignes{\chemfig{HCl}/\chlorure, l'acide est \chemfig{HCl} et la base \chlorure est dans ce couple.}
\end{doc}

\question{
  Indiquer l'acide et la base du couple acide/base \eau/\chemfig{HO^{-}}.
}{}[1]
...
\begin{doc}{Réaction acido-basique}{doc:A3_acido_basique}
  ...
  \exemple On a deux couples : \oxonium/\eau et \chemfig{NH_4^{+}}/\ammoniac.
  ...
  \vspace*{-12pt}
  \begin{center}
    \oxonium + \ammoniac \reaction \eau + \chemfig{NH_4^{+}}
  \end{center}
\end{doc}

\question{
  Établir la réaction acido-basique entre le couple \oxonium/\eau et le couple \eau/\chemfig{HO^{-}}.  
}{}[2]
...
\begin{doc}{Couples acide/base à connaitre}{doc:A3_couple_acide_base}
  ...
  \begin{tblr}{
    ...
    \eau/\chemfig{HO^{-}}         & \eau & eau                             & \chemfig{HO^{-}} & ion hydroxyde \\
