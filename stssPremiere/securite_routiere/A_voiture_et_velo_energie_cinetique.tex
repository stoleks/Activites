\tetePremStssRout
\titreActivite{Voiture, vélo et énergie cinétique}
...
\begin{doc}{Égalité des énergies cinétiques}
...
\question{
  Calculer la vitesse que devrait avoir une cycliste pour avoir la même énergie cinétique qu'un automobiliste qui roule à \qty{30}{\km\per\hour}.
  Est-ce une vitesse facilement atteignable ?
}{
  On remplace par la masse moyenne d'un automobiliste et d'une cycliste
  \begin{equation*}
    v_\text{vélo} 
    = \sqrt{\dfrac{1250 + 81.2}{12 + 67.3}}\times \qty{30}{\km\per\hour}
    = \qty{122}{\km\per\hour}
  \end{equation*}
}[3]