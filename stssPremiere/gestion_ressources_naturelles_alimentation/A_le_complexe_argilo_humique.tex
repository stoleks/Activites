...
\begin{doc}{Le métabolisme des plantes}{doc:A_metabolisme_plante}
  ...
  \begin{importants}
    Les parois des cellule végétales sont composées de \important{cellulose,} un polymère du glucose.
  ...
  \begin{listePoints}
    \item Pour récupérer du carbone, de l'oxygène et de l'azote, les plantes synthétisent du glucose grâce à la \important{photosynthèse} qui a lieue dans les \important{chloroplastes.} Les éléments sont pris directement dans l'atmosphère.
...
\begin{doc}{Le rôle du complexe argilo-humique pour les plantes}{doc:A_role_CAH}
...
\begin{doc}{Les engrais NPK dans l'agriculture intensive}{doc:A_agriculture_intensive}
...
\begin{doc}{Des alternatives pour limiter l'impact environnemental de l'agriculture intensive}{doc:A_alternatives}
  \begin{listePoints}
    ...
    \item \important{Priviligier l'agriculture biologique,} qui interdit l'usage de la plupart des intrants (pesticide et engrais) et limite donc les risques de pollution.
    ...
    \item \important{Limiter très fortement ou interdir l'usage de certains pesticides,} pour protéger les populations d'insectes et d'oiseaux qui s'effondrent en Europe.
    \item \important{Économiser l'eau,} en priviligiant des plantes peu consommatrices, en paillant les sols et en utilisant des systèmes d'arrosage goutte à goutte quand c'est possible.
  \end{listePoints}
\end{doc}