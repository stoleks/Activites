...
\question{
  ...
  Un antiseptique permet de nettoyer une plaie, tandis qu'un désinfectant sert à tuer les micro-organismes sur une surface inerte.
}[1]

\question{
  Quelle est la propriété chimique des principes actifs présent dans les antiseptiques ou les désinfectants ?
}{
  Tous les principes actifs sont de puissant oxydants.
}[1]
