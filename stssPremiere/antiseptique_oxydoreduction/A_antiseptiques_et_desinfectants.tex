...
\begin{contexte}
  ...
  \problematique{
    Quelle est la différence entre antiseptique et désinfectant ?
    Quel est leur action ?
  }
\end{contexte}
...
\begin{doc}{Définition d'un antiseptique et d'un désinfectant}
  ...
  Les désinfectants/antiseptiques reposent \important{sur des principes actifs qui agissent par oxydation.}
\end{doc}

%%
\begin{doc}{Action oxydante sur les micro-organismes}
  \begin{importants}  
    Les antiseptiques et les désinfectants vont \important{oxyder les molécules responsables de la survie ou de la duplication des micro-organismes,} pour inhiber leurs actions ou les détruire.
  \end{importants}
  ...
  \begin{center}
    \image{0.5}{images/exterieures/biologie/bacterie}

    \legende{Schéma d'une bactérie}
  \end{center}
\end{doc}
...
\question{
  ...
  Un antiseptique permet de nettoyer une plaie, tandis qu'un désinfectant sert à tuer les micro-organismes sur une surface ou un objet inerte.
}[2]

\question{
  Quelle est la propriété chimique des principes actifs présents dans les antiseptiques ou les désinfectants ?
}{
  Tous les principes actifs sont de puissants oxydants.
}[1]
...
\question{
  ...
  Les antiseptiques vont détruire les protéines composant les membranes des micro-organismes, modifier des enzymes critiques à leur fonctionnement ou détruire l'ADN et l'ARN des micro-organismes.
}[3]
...
\begin{doc}{Un peu de vocabulaire}
  \begin{importants}
    Les antiseptiques ou les désinfectants sont \important{virucides, bactéricides, fongicides ou sporicides} s'ils peuvent être létal (= tuer) pour les virus, les bactéries, les champignons ou les spores. 
  \end{importants}
...
%%%%
\begin{doc}{Un antiseptique et un désinfectant usuel}
  \centering
  \begin{tblr}{
    ...
    %
    Usages &
    Brûlures et plaies superficielles. Antisepsie du champ opératoire. &
...
\question{
  ...
  La bétadine permet de traiter toutes les plaies couramment rencontrées et tue tous les micro-organismes.
}[2]

\question{
  Expliquer pourquoi le diiode et l'ion hypochlorite sont des oxydants.
}{
  Le diiode gagne 2 électrons, c'est donc un oxydant. De même pour l'ion hypochlorite.
}[2]