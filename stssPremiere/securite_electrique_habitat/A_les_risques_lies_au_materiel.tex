...
\begin{doc}{Installation électrique}
  \begin{center}
    ...
    \image{1}{images/exterieures/donnees/schema_electrique_maison}
  \end{center}
\end{doc}
...
\begin{doc}{Le rôle d'un disjoncteur}
  \begin{wrapfigure}[8]{r}{0.2\linewidth}
    \vspace*{-24pt}
    \centering
    \image{0.9}{images/electromagnetisme/disjoncteur_differentiel}
  \end{wrapfigure}
...
\begin{doc}{Court-circuit}
  \qrcodeCote{https://www.youtube.com/watch?v=UCTwDyTFyns}%(-32pt)
...
\begin{doc}{Caractéristique de la multiprise}[\label{doc:multiprise}]
  \begin{wrapfigure}{r}{0.2\linewidth}
    \vspace*{-24pt}
    \centering
    \image{1}{images/electromagnetisme/multiprise}
  \end{wrapfigure}
...
\begin{doc}{Appareils connectés à la multiprise}[\label{doc:appareils_multiprise}]
...
\question{
  À l'aide des documents~\ref{doc:multiprise} et~\ref{doc:appareils_multiprise}, expliquer si Myriam peut connecter sur la même multiprise les trois appareils et les faire fonctionner simultanément sans risques ?
}{}[3]

\question{
  En vous aidant des informations données dans le document~\ref{doc:lampe_therapeutique} et en admettant que l'intensité du courant circulant dans la lampe ne dépend pas de la tension d'alimentation, expliquer la conséquence d’utiliser la lampe infrarouge en France.
}{}[3]
