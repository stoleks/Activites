...
\begin{doc}{La prise de terre}[\label{doc:prise_terre}]
  ...
  \begin{wrapfigure}{l}{0.2\linewidth}
    \centering
    \vspace*{-14pt}
    \image{1}{images/exterieures/prise_terre.jpg}
  \end{wrapfigure}
...
\begin{doc}{Effet physiologique observée}[\label{doc:effet_physiologique}]
  \begin{center}
    \image{0.48}{images/exterieures/donnees/danger_electrisation_ampere}
    \image{0.48}{images/exterieures/donnees/effet_physiologique_electrisation}
