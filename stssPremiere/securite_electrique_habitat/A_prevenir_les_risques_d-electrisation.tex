...
\begin{doc}{La prise de terre}[\label{doc:prise_terre}]
  ...
  \begin{wrapfigure}{l}{0.2\linewidth}
    \centering
    \vspace*{-14pt}
    \image{1}{images/exterieures/electricite/prise_terre.jpg}
  \end{wrapfigure}
...
\begin{doc}{Tension et intensité}
  \begin{importants}
...
\begin{doc}{Effet physiologique observée}[\label{doc:effet_physiologique}]
  \begin{center}
    \image{0.5}{images/exterieures/electricite/danger_electrisation_ampere}
    \image{0.46}{images/exterieures/donnees/effet_physiologique_electrisation}
...
\question{
  ...
  À l’aide du document~\ref{doc:prise_terre}, expliquer quels dangers sont écartés grâce à la prise de terre.
}{
...
\question{
  ...
  À l’aide du document~\ref{doc:effet_physiologique} prévoir quels vont être les effets physiologiques.
}{
