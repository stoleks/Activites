...
\begin{doc}{Nommer une chaîne carbonée}
  ...
  \input{commun/prefixe_organique}
\end{doc}
...
\begin{doc}{Groupes caractéristiques}[\label{doc:nom_groupe_carac}]
  \input{commun/nom_familles_organiques}
\end{doc}

\question{
  Nommer la molécule du document~\ref{doc:nom_groupe_carac}.
}{
  4-méthyl-pent-2-ol
}[2]
