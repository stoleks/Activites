...
\begin{contexte}
  Un acide et une base forment un couple si l'on peut passer de l'un à l'autre par la perte ou le gain de proton \chemfig{H^+}.
...
\begin{doc}{La réaction d'oxydoréduction}{doc:A1_reaction_redox}
  ...
  Le gaz \chemfig{O_2} va réagir avec le solide \chemfig{Fe}, pour se transformer en ion \chemfig{Fe^{3+}} et en ion \chemfig{O^{2-}}, qui vont se combiner pour former de la rouille \chemfig{Fe_2O_3}.
...
\begin{doc}{L'arbre de Diane}{doc:A1_arbre_diane}
  ...
  \moleculesGras
  On introduit dans un erlenmeyer une solution incolore de nitrate d'argent, qui est concentrée en \important{ions argent $\chemfig{Ag^+}\aq$.}
