...
%%%% Éléments et molécules récurrentes, pour faciliter la lecture et l'écriture
...
\definesubmol\prostaglandine{
  HO-[::75] *5(
    - (-=[::60]!\cd  (!\cd HO) !\cud !\cud !\cu)
    - (-[::-65]!\cd !\cud !\cud !\cu  !\carboxyle)
    - (=O)
    --
  )
}
...
\definesubmol\cyanocobalamine{
  -[::-5]  *5( % cycle haut droit du cobalt
    ...
    - (-[::-90]) (-[::-35])
    - N = (
      - (-[::60]) =[::-60]  *5( % cycle haut gauche du cobalt
        - N = (
          -=[::-60]  *5( % cycle bas gauche du cobalt
            - N = (
              - (-[::60]) =[::-60]  *5( % cobalt
                - N (-Co !\cu C)
                -- (- !\cd (=[::-60] O) !\cu NH_2)
