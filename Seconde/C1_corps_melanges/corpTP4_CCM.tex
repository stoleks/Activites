...
\question{
  En analysant le chromatogramme à l'aide du document~\ref{doc:TP4_chromatogramme}, indiquer si les échantillons sont des corps purs ou des mélanges.
}{}{4}

\question{
  En utilisant le chromatogramme, donner la composition des colorants présents sur la couche externe des MM's.
}{}{6}
...
\begin{doc}{Résultat d'une CCM}{doc:TP4_chromatogramme}
  ...
  \begin{multicols}{2}
    \centering
    \image{0.5}{images/donnees/chromato_HEC}
    
    \image{0.5}{images/donnees/chromato_HEO}
  \end{multicols}
  
\end{doc}

\question{
  En analysant les chromatogramme, donner la composition de l'HEC et l'HEO.
}{
