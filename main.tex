...
\begin{document}
  ...
  % \input{stssTerminale/representation_molecules_organiques/A2_famille_orga}
  %% Sécurité routière
  ...
  % \input{stssTerminale/securite_physico_chimique_alimentation/TP1_lait_degre_dornic}
  ...
  % \input{stssTerminale/securite_chimique_environnement/TP1_controle_qualite}
  ...
  % \input{stssTerminale/biomolecules_alimentation/A3_vitamines}
  % \input{stssTerminale/biomolecules_alimentation/A4_lipides}
  ...
  % \input{stssTerminale/usage_reponsable_cosmetique/A1_}
  ...
  %%%% Seconde
  % \input{seconde/A1_notation_scientifique} % début 1h
  % \input{seconde/TP1_secu_labo} % début 1h
  % \input{seconde/A2_analyse_dimensionnelle} % début mécanique 1h
  % \input{seconde/A3_ordres_grandeurs} % début atome 1h
