...
%%%% figures, chapitres et petites macros
\input{macros}
\input{figures}
\input{chapitres}
...
\begin{document}
  %% chapitre 1
  %\input{termST2S/C0_representation_organique/orgaA1_representation_molecule}
  ...
  % \input{chapitre7_signaux_capteurs/ElecAE2_son_vitesse}
\end{document}