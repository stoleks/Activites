...
\ExplSyntaxOn
% Position de la place horizontale et verticale
\int_new:N \l_rangPositionX_int
\int_new:N \l_rangPositionY_int 
\NewDocumentCommand{\rang}{m >{\SplitList{,}} m >{\SplitList{,}} m >{\SplitList{,}} d[]}{
  % Calcul de la position verticale et horizontale
  \int_set:Nn \l_rangPositionY_int {0 - 3*#1}
...
\NewDocumentCommand{\rangImpl}{m}{
  ...
  \place(\l_rangPositionX_int)(\l_rangPositionY_int){#1} %
}
\ExplSyntaxOff
