...
\begin{doc}{Les 20 acides $\mathbf{\alpha}$-aminés protéinogènes}[\label{doc:acides_amines}]
...
\begin{doc}{La tyrosinase}
  ...
  \medskip
  \begin{center}
    \chemfig{... -[:-30] !\NH !\tryptophaneH !\HN !\threonineB !\NH !\histidineH !\HN !\tyrosineB O !\lh ...}
  \end{center}
\end{doc}
...
\question{
  En vous aidant du document~\ref{doc:acides_amines}, dire si ces quatres acides alpha-aminés sont hydrophobes ou hydrophiles.
}{
