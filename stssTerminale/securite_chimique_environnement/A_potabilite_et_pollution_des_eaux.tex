...
\begin{doc}{Potabilité d'une eau}
  ...
  \begin{tblr}{
    ...
    \chlorure    & \qty{200}{\mg\per\litre} \\
    \ionSodium   & \qty{200}{\mg\per\litre} \\
    \sulfate     & \qty{250}{\mg\per\litre} \\
    pH           & Entre \num{6,5} et \num{9} \\
...
\question{
  Indiquer quelle eau du document~\ref{doc:eau_minerale} est potable selon les critères de l'OMS.
}{}[4]
...
\begin{doc}{Impact des activités humaines sur la qualité chimique de l'eau}
  ...
  \qrcodeCote[0]{https://edurl.fr/LFtatKMB}(-70pt)
  %https://www.eaufrance.fr/la-qualite-des-rivieres}(-35pt)
