...
\begin{doc}{Composition de l'air}{doc:TP2_composition_air}
  \begin{center}
    \begin{tblr}{
      ...
      Diazote            & \chemfig{N_2}  & \qty{78,08}{\percent} \barrePourcentage{0.7808} \\
      Dioxygène          & \dioxygene     & \qty{20,95}{\percent} \barrePourcentage{0.2095} \\
      Argon              & \chemfig{Ar}   & \qty{0,93}{\percent} \barrePourcentage{0.01} \\
      Dioxyde de carbone & \chemfig{CO_2} & \qty{0,04}{\percent} \barrePourcentage{0} \\
      ...
      Méthane            & \chemfig{CH_4} & \qty{1,9}{\ppm}  \barrePourcentage{0} \\
      Eau                & \eau           & Variable \\ 
    \end{tblr}
  \end{center}
...
\begin{doc}{Quelques tests pour identifier des espèces chimiques}{doc:TP2_tests_identification}
  ...
  En présence de dioxyde de carbone \chemfig{CO_2}, l'eau de chaux se trouble. C'est dû à la formation d'un précipité blanc de carbonate de calcium \chemfig{CaCO_3}.

  \pointCyan Le sulfate de cuivre anhydre \chemfig{CuSO_4} est une poudre blanche.
  En contact avec des molécules d'eau \chemfig{H_2O} la poudre bleuit. C'est dû à la formation d'un complexe pentahydrate \chemfig{CuSO_4, 5H_2O}.
