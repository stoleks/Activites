...
\begin{doc}{Composition de l'air}{doc:TP2_composition_air}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \fill[color = couleurSec300] (0.7808*90ex, 0.0) rectangle (0.9903*90ex, 3ex);
      \fill[color = couleurSec100] (0.9903*90ex, 0.0) rectangle        (90ex, 3ex);
      % Valeurs
      ...
      \fill[color = couleurSec300] (75ex, 11ex) rectangle (78ex, 8ex);
      \fill[color = couleurSec100] (75ex, 7ex)  rectangle (78ex, 4ex);
      % Légende
