...
\begin{doc}{L'augmentation de « l'effet de serre »}
...
\begin{doc}{Les activités humaines source de gaz à effet de serre}[\label{doc:source_GES}]
...
\question{
  En utilisant le lien fourni dans le document~\ref{doc:source_GES}, indiquer si en Europe et dans le monde la répartition des émissions de gaz à effet de serre par secteur est la même.
}{}[2]

\question{
  En utilisant le lien fourni dans le document~\ref{doc:source_GES}, indiquer la part des émissions qui sont dues à l'utilisation de voitures individuelles.
}{}[2]
...
\question{
  En utilisant le lien fourni dans le document~\ref{doc:alim_GES}, calculer la proportion des émissions de gaz à effet de serre qui sont liées à la production de viande et de poisson.
}{}[3]