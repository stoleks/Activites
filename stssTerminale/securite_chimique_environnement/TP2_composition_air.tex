...
\begin{doc}{Composition de l'air}{doc:TP2_composition_air}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      % Valeurs
      \node[white] at (0.7808*45ex, 1.5ex) {\important{\qty{78,08}{\percent}}};
      \node[black] at (0.8855*90ex, 1.5ex) {\important{\qty{20,95}{\percent}}};
      \node[black] at        (91ex, 1.5ex) {\important{\qty{0,97} {\percent}}};
      % Carré légende
      ...
      % Légende
      \node[black,right] at (78ex, 13.5ex) {\important{Diazote}};
      \node[black,right] at (78ex, 9.5ex)  {\important{Dioxygène}};
      \node[black,right] at (78ex, 5.5ex)  {\important{Autres gaz}};
    \end{tikzpicture}
  \end{center}
...
\begin{doc}{Combustion d'une bougie}{doc:TP2_combustion_bougie}
  ...
  \important{Protocole :} remplir la coupelle d'eau.
