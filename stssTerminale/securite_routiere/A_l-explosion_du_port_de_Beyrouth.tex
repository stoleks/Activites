...
\begin{doc}{Tableau descriptif des espèces chimiques}{doc:A1_descriptif_especes_chimiques}
  ...
  \begin{tblr}{
    ...
    Formule brute & \chemfig{NH_4 NO_3} & \diazote & \dioxygene & \eau \\
...
\begin{doc}{Faire un bilan de matière}{doc:A1_bilan_matiere}
  ...
  \begin{center}
    ...
    \important{2}\diazote\gaz + \dioxygene\gaz + \important{4}\eau\liq
  \end{center}
  Si je mélange \important{deux} \chemfig{NH_4 NO_3}, il se forme \important{deux} \diazote,
  \important{un} \dioxygene\; et \important{quatre} \eau.
  
  Si je mélange 4 \chemfig{NH_4 NO_3}, il se forme 4 \diazote, 2 \dioxygene\; et 8 \eau.
  
  Si je mélange 6 \chemfig{NH_4 NO_3}, il se forme \texteTrou{6} \diazote, \texteTrou{3} \dioxygene\; et \texteTrou{12} \eau.
...
\question{
  ...
  À partir du document~\ref{doc:A1_bilan_matiere}, nommer les réactifs et les produits de cette réaction chimique. 
...
\begin{tblr}{
  ...
  \SetCell[c=2]{c} 2 \chemfig{NH_4 NO_3}\sol \reaction 2 \diazote\gaz \qq{}\qq{} & &
  \dioxygene\gaz &
  4 \eau\liq \\
  %
...
\vspace*{8pt}
\question{
  En utilisant le document~\ref{doc:A1_calcul_mole_sol_gaz} et le tableau ci-dessus, calculer (dans les conditions normales), le volume de diazote $V(\diazote)$,
