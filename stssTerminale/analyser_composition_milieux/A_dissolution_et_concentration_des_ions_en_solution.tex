...
\begin{doc}{Neutralité des solutions}
  ...
  \legende{Dissolution du chlorure de sodium}
\end{doc}
...
\begin{doc}{Équation de dissolution et calcul de concentration}
  ...
  \exemple Pour la dissolution du chlorure d'aluminium, une entité de chlorure d'aluminium \chemfig{Al Cl_3} produit 1 ion aluminium III \chemfig{Al^{3+}} et 3 ions chlorure \chlorure.
...
\question{
  ...
  \begin{equation*}  
    c(\chemfig{FeCl_2}) = \dfrac{c_m (\chemfig{FeCl_2})}{M(\chemfig{FeCl_2})}
  \end{equation*}
  \begin{donnees}
...
\question{
  En déduire la concentration en quantité de matière des ions fer notés $[\ionFerII]$ et des ions chlorure notés $[\chlorure]$.
}{}[6]