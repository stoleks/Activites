...
\begin{doc}{Acidification de l'eau et des océans}{doc:A2_acidification}
  ...
  La concentration en ion oxonium \oxonium augmente, ce qui est néfaste pour les mollusques et les coraux, car l'ion oxonium vient dissoudre leur coquilles composées de calcaire, le carbonate de calcium \chemfig{Ca^{2+}} + \chemfig{CO_3^{2-}}.
...
\question{
  ...
  \begin{center}
    \oxonium + \chemfig{CO_3^{2-}} \reaction
    \eau + \chemfig{HCO_3^{-}}
  \end{center}
}[1]
