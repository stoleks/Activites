\teteTermStssAlim
\titreTP{Contrôler la fraîcheur d'un lait}
...
%%%%
\schematisation Lire les documents et compléter le schéma du document~\ref{doc:dispositif_experimental}.
...
Quand la solution change de couleur et que la couleur persiste après agitation, noter la valeur approximative $V_1 =$ \texteTrou[0.1]{\qty{4,5}{\ml}} du volume de soude versé.
...
%%
\begin{doc}{Préparation du dispositif expérimental}[\label{doc:preparation}]
  \begin{protocole}
