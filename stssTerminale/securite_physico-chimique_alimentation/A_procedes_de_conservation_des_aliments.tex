...
\begin{contexte}
  ...
  \problematique{
    Quels procédés de conservations peut-on utiliser pour limiter la prolifération de micro-organisme ?
  }
\end{contexte}
...
\begin{doc}{Quelques méthodes de conservation}
  \begin{tblr}{
...
\documentaire Pour chaque méthode de conservation, indiquer si c'est un procédé physique ou chimique.
