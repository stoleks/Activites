...
\begin{doc}{Mécanisme de brunissement}
  \begin{wrapfigure}{r}{0.3\linewidth}
    ...
    \legende{Benzène-1,2-diol : \\ exemple de polyphénol}
  \end{wrapfigure}
...
\begin{doc}{Réaction chimique responsables du brunissement}[\label{doc:reaction_brunissement}]
  Lorsque les \important{polyphénols} se mélangent au \important{polyphénol oxydase PPO} et au \important{dioxygène}, ils créent un composé appelé \important{ortho-quinone}.
