...
\begin{doc}{Techniques de conservation des aliments}
  ...
  Une autre technique et d'empêcher la prolifération des micro-organismes en retirant l'eau d'un aliment, c'est la \important{déshydratation.}
\end{doc}
...
\separationBlocs{
  \begin{doc}{Gâteau à analyser}
    \image{1}{images/exterieures/conservation/gateau_DJA_DJT}
  \end{doc}
}{
  \begin{doc}{Analyse du dessert}
    \centering
...
\smallskip
\question{
  Indiquer les méthodes de conservations utilisées pour préserver le lait dans le gâteau à analyser.
