...
%%%% Aspirine
\begin{doc}{Premiers usage de l'acide salicylique}
...
\begin{doc}{Première synthèse de l'aspirine}
...
\begin{doc}{Action de l'acide acétylsalicylique dans le corps humain}
  ...
  La molécule inhibe la formation de \important{prostaglandines,} des molécules importantes pour la perception de la douleur dans notre corps.

  L'acide acétylsalicylique est le \important{principe actif} de l'aspirine, un des médicaments les plus utilisés dans le monde.
  L'aspirine est \important{antalgique} (calme la douleur), \important{antipyrétique} (diminue la fièvre), \important{anti-inflammatoire} (diminue les inflammations locales) et \important{antiagrégant plaquettaire} (limite la formation de caillot sanguin), ce qui la rend utile pour lutter contre certaines maladies cardio-vasculaires.
\end{doc}


%%%% 
\begin{doc}{Les médicaments}
  \begin{importants}
  ...
  On peut donc avoir plusieurs médicaments qui ont le même principe actif, mais différents excipients.
  C'est ce qui différencie un médicament breveté (comme l'aspirine) et un médicament générique, dans le domaine public.
  
  En plus de l'aspirine, un autre exemple est le doliprane (médicament breveté), dont le principe actif est le paracétamol (médicament générique).
...
\question{
  Entourer et nommer les groupes fonctionnels de l'acide salicylique, de l'acide acétylsalicylique et du paracétamol.
}{}[3]


\begin{doc}{Les nanomédicaments}
