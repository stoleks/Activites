...
\exo{Compléter les documents~\ref{doc:trajectoires} et~\ref{doc:vitesse}.}{0}
...
\vspace*{6pt}
\exo{Pour la personne qui filme les oies, quelle est la vitesse des oies ?}{0}
\exo{Pour une personne se trouvant sur la berge, quelle est la vitesse des oies ?}{0}
\exo{Schématiser la trajectoire des oies si on les observe depuis la berge.}{0}
\exo{Indiquer le mouvement des oies depuis le bateau et la berge.}{0}
...
\vspace*{-6pt}
\exo{Depuis le point de vue centré sur la Terre, quelle est la vitesse de la Lune ?}{0}
\exo{Schématiser la trajectoire de la Lune depuis ce point de vue et indiquer son mouvement.}{0}
\exo{Peut-on décrire la vitesse de la Lune depuis le point de vue centré sur le Soleil ?}{0}
\exo{Schématiser la trajectoire de la Lune depuis ce point de vue.}{0}


\titreSection{Notion de référentiel}

\exo{Convertir la vitesse $v_\text{Lune}$ en m/s.
\textit{Rappel : } $1\unit{km} = 10^3\unit{m}$, $1\unit{h} = 3,\!6 \times 10^3 \unit{s}$.}{0}
\exo{Quelle distance la Lune parcours pendant 1 seconde ? Comparer avec la longueur de sa trajectoire, qui est de $2,4\times 10^6 \unit{km}$}{0}
\exo{Est-ce que la seconde est une durée d'observation suffisante pour décrire la trajectoire de la Lune ?}{0}
\exo{Conclusion : pourquoi est-il important de définir le référentiel, qui est l’endroit où on se place et le temps passé à observer, avant d'étudier un mouvement ?}{0}
