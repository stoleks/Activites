...
\question{
  Calculer la concentration $c$ en \unit{\g/\ml} de paracétamol dans la solution préparée par le père.
}{}{4}

\question{
  Quel volume $V_2$ de la solution Inès doit-elle boire pour avaler \qty{300}{\milli\g} de paracétamol ?
}{}{6}