...
%%%% titre
\vspace*{-36pt}
\titreActivite{Spectres d'émission}
...
\begin{doc}{Lampe à incandescence}
...
\begin{doc}{Émission d'un corps chaud}
  \begin{importants}
    Un corps chaud émet \texteTrou(1){un rayonnement lumineux avec un spectre continu.} 
...
\begin{doc}{Émission atomique ou moléculaire}[\label{doc:emission_atomique}]
  \begin{importants}
  ...
  \begin{wrapfigure}[10]{r}{0.55\linewidth}
    \centering
    \vspace*{-22pt}
    \image{1}{images/exterieures/donnees/spectre_gaz}
  \end{wrapfigure}
...
\question{
  En comparant les spectres données dans le document~\ref{doc:emission_atomique}, indiquer si les lampes éclairant la classe contiennent de l'hydrogène, du néon ou du mercure.
}{
  ...
  Par ailleurs on retrouve aussi les raies vertes du mercure, donc la lampe contient aussi du mercure.
}[4]