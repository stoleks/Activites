...
\begin{doc}{Évolution de l'indice de réfraction $\mathbf{n}$ d'un verre}[\label{doc:indice_verre}]
  \begin{center}
...
\newpage
\vspace*{-36pt}
\begin{doc}{Rappel sur la réfraction}[\label{doc:rappel_refraction}]
