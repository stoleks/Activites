...
%%
\begin{doc}{Sueur et fraîcheur}[\label{doc:evaporation}]
...
%%%% Questions
\question{
  Pour chaque documents (\ref{doc:climatisation}, \ref{doc:glacons}, \ref{doc:evaporation}), indiquer quel est le corps qui change d'état, avec l'état initial et l'état final.
}{
  Pour le document~\ref{doc:climatisation}, ce sont les gouttelettes d'eau qui passent de l'état liquide à l'état gazeux.

  Pour le document~\ref{doc:glacons}, ce sont les glaçons d'eau qui passent de l'état solide à l'état liquide.

  Pour le document~\ref{doc:evaporation}, c'est les gouttes de sueur, qui passent de l'état liquide à l'état gazeux.
}[5]
