...
%%%% titre
\vspace*{-32pt}
\titreTP{Compter un grand nombre dentités identiques}
...
\question{
  Calculer la masse moyenne d'un grain de riz $m_\text{grain}$ à partir de la masse de 100 grains de riz.
}{
...
\question{
  À partir de la masse moyenne d'un grain de riz, calculer le nombre $N$ de grains de riz dans un sac de riz de \qty{1}{\kg}.
}{
...
\begin{doc}{Composition du sucre}
...
\begin{tblr}{
  ...
  %
  Nombre d'entités $N$     & \correction{\num{25000}} & \correction{\num{3,34e24}} \\
  Taille d'un paquet $N_A$ & \num{100}                & \qty{6,02e23}{\per\mole} \\
  Nombre de paquets $n$    & \correction{\num{250}}   & \correction{\qty{5,55}{\mole}} \\
\end{tblr}
