...
\begin{doc}{Neutralité de la matière}
  La matière macroscopique qui nous entoure est composé d'un très (très) grand nombre d'entités chimiques identiques, plus de \num{e23} dans un dé à coudre d'eau !
...
\begin{doc}{Solides moléculaires}
  ...
  \end{importants}
  \exemple* l'eau est composée de molécules \chemfig{H_2O}.
...
\begin{doc}{Molécule biologiques et êtres vivants}
  \qrcodeCote[2]{https://youtu.be/l2DBizRGIIU?t=18}
  \strut\vspace*{-20pt}
