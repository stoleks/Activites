...
\begin{doc}{Électrons de valences}
  Les éléments chimiques ont tendance à s'associer en molécule, afin de gagner en stabilité en complétant leur couches électroniques externes.
...
\begin{doc}{Doublets liants et liaison covalente}
  En 1916, Lewis propose un modèle simple pour schématiser la formation des liaisons entre éléments chimiques :
  \begin{importants}  
    Les éléments qui s'associent en molécule vont mettre en commun un des électrons de leur couche externe, \important{ce qui leur permet de ``gagner'' un électron}.
  \end{importants}
  \begin{importants}
    Ces électrons mis en commun s'associent par paire appelée \important{doublet liant}.
    En partageant leurs électrons les éléments deviennent liés, on parle de \important{liaison covalente.}
  \end{importants}
  
  \exemple Formation de la molécule de dihydrogène \chemfig{H_2} à partir de deux éléments \isotope{H}{1}{} :
  ...
  \begin{multicols}{2}
    \begin{center}
      ...
      {\Huge \chemfig{H -[, 1.75,,,, red-600, line width = 3 pt] H}}
...
\newpage
\question{
  Rappeler la configuration électronique de l’hydrogène \isotope{H}{1}{}, du carbone \isotope{C}{6}{}, de l’azote \isotope{N}{7}{} et de l'oxygène \isotope{O}{8}{}.
  Identifier pour chacun de ces atomes leurs électrons de valences.
}{
  \isotope{H}{1}{} : $1s^1$
  
  \isotope{C}{6}{} : $1s^2 2s^2 2p^2$
  
  \isotope{N}{7}{} : $1s^2 2s^2 2p^3$
  
  \isotope{O}{8}{} : $1s^2 2s^2 2p^4$
}[5]
...
\begin{doc}{Doublets non-liants}
  ...
  \exemple Formation de la molécule d'eau \eau à partir de 2 atomes \isotope{H}{1}{} et d'un atome \isotope{O}{8}{} :
  \vspace{8pt}
  ...
  \separationBlocs{
    \begin{center}
      ...
      \image{0.7}{images/molecules/molecule_H2O}
    \end{center}
  }{
    \begin{center}
...
\question{
  Indiquer combien de doublets non-liants la molécule d'eau possède.
}{
  Elle possède deux doublets non liants.
}[2]
...
\begin{doc}{Liaisons multiples}
  ...
  \separationBlocs{
    ...
    \begin{center}
      ...
      \image{0.7}{images/molecules/molecule_O2}
    \end{center}
  }
  \vspace{12pt}
  ...
  \separationBlocs{
    \begin{center}
      ...
      \image{0.7}{images/molecules/molecule_N2}
    \end{center}
  }{
    \begin{center}
      {\small Schéma de Lewis}
...
%%%% questions
\question{
  Quelles molécules peut-on former à partir d'un carbone, d'un oxygène et de plusieurs hydrogènes ?
}{
...
\begin{doc}{Règles de stabilité}
  \begin{importants}
    ...
    Pour savoir combien de liaisons un élément peut former,
    \texteTrou(2){il suffit de compter le nombre d'électrons de valence et le nombre d'électrons manquant pour que la couche externe soit complète.}
  \end{importants}
\end{doc}
