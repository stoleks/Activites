...
\begin{doc}{Onde électromagnétique}{doc:A1_onde_EM}
  \begin{encart}
    Une onde est une \important{perturbation} qui se \important{propage.}
  \end{encart}
...
\question{
  Chercher et donner des exemples de phénomènes qui s'apparente à des ondes.
}{}{3}
...
\begin{doc}{Spectre électromagnétique}{doc:A1_spectre_EM}
  ...
  \begin{center}
    \image{1}{images/lumiere/spectre_EM.jpg}
  \end{center}
...
\question{
  Calculer le temps que met le TGV pour parcourir \qty{1000}{\km} (distance Paris-Marseille).
}{
  \begin{align*}
