...
\begin{doc}{Rappel sur la détermination graphique d'une image}{doc:TP1formation_image}
  ...
  \begin{center}
    \image{0.8}{images/lumiere/image_lentille_convergente}
  \end{center}
...
%%
\begin{doc}{Rappel sur le grandissement}{doc:TP1rappel_grandissement}
  \begin{encart}
...
\question{
  En utilisant le théorème de Thalès dans le document~\ref{doc:TP1formation_image}, montrer que 
...
\question{
  En comparant les valeurs de $\gamma$ calculées question~\ref{exo:grandissement_def} et~\ref{exo:grandissement_thales}, est-ce que la modélisation proposée dans le document~\ref{doc:TP1formation_image} vous semble valide ?
}{
  ...
}{2}
