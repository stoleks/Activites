...
\begin{contexte}
  Dans la vie de tous les jours, on rencontre de très nombreuse transformations chimique : combustion d'un solide, corrosion du fer, production d'un courant avec des piles ou une batterie, coloration des aliments pendant la cuisson, etc.
