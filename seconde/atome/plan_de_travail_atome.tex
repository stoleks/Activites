...
Je note à chaque séance quelle activité j'ai fait entièrement ou à quelle question j'étais à la fin de l'heure sinon.
Je note les mots-clés des activités réalisées
\medskip
...
\begin{programmeSeance}[distance = 0pt]
...
%%%% Tâche finale
\begin{tacheFinale}
  \important{Par groupe de 4,} choisir un élément du tableau périodique et réaliser sa case sur une feuille au format A4 $\num{29,7} \times\qty{21,0}{\cm\squared}$.
  La case devra contenir des informations microscopique (structure électronique) et des informations macroscopique : dans quels objets on trouve l'élément, sous quels formes naturelles l'élément se trouve sur Terre, est-ce un élément important en biologie, des propriétés remarquables ou amusantes, etc.

  La feuille doit être mise en page de sortes que l'on puisse reconnaître du premier coup d’œil l'élément chimique représenté, même si on est loin de la feuille.
\end{tacheFinale}
