...
\begin{doc}{Volume d'un parallélépipède rectangle}
  \begin{multicols}{2}
    ...
    \begin{tikzpicture}
      ...
      \draw (1.25,-2) -- (1.25,0);
      \tikzVecteur* (1.5, 0) (0, -2) {$h$} [right]
      \tikzVecteur* (-1.25, 0) (1.25, 0) {$r$} [right]
      \tikzLabel (0, 0) {}
    \end{tikzpicture}
  \end{multicols}
\end{doc}
...
\question{
  En utilisant les données du document~\ref{doc:proprietes_metaux}, déterminer la nature de l'échantillon.
}{
