...
\begin{doc}{Composition de l'atmosphère}{doc:A1_composition_atmo}
  \begin{importants}
    L’air contient \texteTrou[0.1]{\qty{78}{\percent}} de diazote \diazote et \texteTrou[0.1]{\qty{21}{\percent}} de dioxygène \dioxygene.
...
%%%%
\question{
  Calculer le volume occupé par le diazote \diazote dans une salle de cours de \qty{600}{\metre\cubed}.
}{
  Le diazote occupe \qty{78}{\percent} du volume, soit $V_{\diazote} = 0,78 \times \qty{600}{\metre\cubed} = \qty{468}{\metre\cubed}$.
}[2]

\question{
  Même question pour le dioxygène \dioxygene.
}{
  Cette fois $V_{\dioxygene} = 0,21 \times \qty{600}{\metre\cubed} = \qty{126}{\metre\cubed}$.
...
\question{
  Calculer la proportion volumique de dioxyde de carbone \dioxydeDeCarbone après une heure de cours.
}{
...
\begin{doc}{Cloche en bronze}{doc:A1_cloche_bronze}
  \begin{wrapfigure}[5]{r}{0.2\linewidth}
    \vspace*{-31pt}
    \centering
    \image{0.7}{images/exterieures/pur_melange/cloche_bronze.png}
  \end{wrapfigure}
