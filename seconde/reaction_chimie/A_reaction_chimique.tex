...
\begin{doc}{Observations macroscopiques}
  ...
  \begin{importants}  
    Les espèces qui sont présentes avant la transformation sont les \important{réactifs.}
    Celles qui sont présentes après la transformation sont les \important{produits.}
  \end{importants}
