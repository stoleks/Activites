...
\begin{center}
  \begin{tblr}{
    ...
    \qty{0,5}{\g} & \correction{non} & \correction{\textbf{+}} \\
    \qty{1,0}{\g} & \correction{non} & \correction{\textbf{++}} \\
    \qty{1,5}{\g} & \correction{non} & \correction{\textbf{+++}} \\
    \qty{2,6}{\g} & \correction{oui} & \correction{\textbf{++++}} \\
    \qty{4,0}{\g} & \correction{oui} & \correction{\textbf{++++}} \\
  \end{tblr}
\end{center}
...
\question{
  ...
  Pour les 3 premiers cas, le réactif limitant est le bicarbonate de sodium \bicarbonateDeSodium, car tous le bicarbonate solide a disparu.
  Pour les 2 deux derniers cas c'est le vinaigre, car il reste du bicarbonate solide.
}[3]
...
\question{
  ...
  Réactifs : \bicarbonateDeSodium\sol et \chemfig{C_2H_4O_2}\liq.
}[2]

\question{
  Lister les produits de la réaction chimique, en précisant leur états physique.
}{
  Produits : \ionSodium\aq, \dioxydeDeCarbone\gaz, \eau\liq et \chemfig{C_2H_3 O_2^{-}}\aq.
}[2]
...
\question{
  ...
  \begin{equation*}
    \bicarbonateDeSodium\sol + \chemfig{C_2H_4O_2}\liq
    \reaction
    \ionSodium\aq + \dioxydeDeCarbone\gaz + \eau\liq + \chemfig{C_2H_3 O_2^{-}}\aq
  \end{equation*}
}[4]

%%
% \begin{doc}{Masse d'une mole des réactifs}{doc:A_masse_molaire_reactif}
