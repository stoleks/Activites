%%%%
\teteSndSign
\titreActivite{Loi des nœuds et loi des mailles}
...
\question{
  ...
  5 dipôles, 2 nœuds et 2 mailles.
}[1]
...
\begin{doc}{Loi des nœuds et intensité}
  ...
  %
  \begin{importants}
    \important{Loi des nœuds} : la somme des intensités entrant dans un nœud est égale à la somme des intensité sortant du nœud.
  \end{importants}
  %
...
\question{
  Donner la relation imposée par la loi des nœuds entre les intensités $I_1$, $I_2$ et $I_3$ dans le circuit du document~\ref{doc:circuit_exemple_del}.
}{
  $I_1 = I_2 + I_3$
}[1]
