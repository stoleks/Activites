...
\begin{doc}{Facteur de dilution}
  \begin{wrapfigure}[2]{r}{0.15\linewidth}
    \vspace*{-36pt}
    \begin{equation*}
  ...
  Le \important{facteur de dilution} est le rapport du volume de la solution fille sur le volume de la solution mère, on dit qu'on a dilué $F$ fois une solution
\end{doc}
