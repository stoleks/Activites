...
\begin{doc}{Concentration en hémoglobine}[\label{doc:anemie}]
  ...
  On parle d'anémie si cette concentration massique est inférieure a
...
%
\question{
  Pour préparer des solutions, on peut effectuer une dilution ou une dissolution. Indiquer en justifiant laquelle des deux méthodes on utilise pour passer de la solution 2 à la solution 3.
}{
...
%
\question{
  En utilisant la figure du document~\ref{doc:anemie}, indiquer en justifiant la concentration en hémoglobine de l'échantillon de sang.
}{
