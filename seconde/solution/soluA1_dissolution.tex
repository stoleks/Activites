...
\vspace*{-36pt}
\numeroActivite{1}
\titreTP{Mal de tête et dissolution}
...
\begin{doc}{Concentration massique}{doc:A1_concentration_massique}
  \begin{importants}
    ...
    C'est le rapport de la masse de \textbf{soluté} dissous sur le volume total de la \textbf{solution}
    \begin{equation*}
...
\question{
  Calculer la concentration $c$ en \unit{\mg/\ml} de paracétamol dans la solution préparée par le père.
}{
  \begin{equation*}
    c = \dfrac{m_1}{V_1}
      = \dfrac{\qty{500}{\mg}} {\qty{25}{\centi\litre}}
...
\question{
  Quel volume $V_2$ de la solution Inès doit-elle boire pour avaler $m_2 = \qty{300}{\milli\g}$ de paracétamol ?
}{
  \begin{equation*}
    V_2 = \dfrac{m_2}{c}
