  ...
  \separationBlocs{
    \begin{center}
      \begin{tblr}{c | c | c | c | c | c}
        Solution &
        {\tubeEssaisSolution{red600}          \\ 1} &
        {\tubeEssaisSolution{red400} \\ 2} &
        {\tubeEssaisSolution{red200} \\ 3} &
        {\tubeEssaisSolution{red100} \\ 4} &
        {\tubeEssaisSolution{red50}  \\ 5} \\ \hline
        %
