...
\begin{tblr}{
  ...
  %
  {\image{1}{images/mecanique/exemple_mouvement_0003} \\ Balle de tennis} &
  Centre de la balle & 
  \correction{Curviligne.} & 
  \correction{La taille de la balle et sa rotation.} \\
  %
  {\image{1}{images/mecanique/exemple_mouvement_0002} \\ Roue} &
  Centre de la roue &
  \correction{Rectiligne.} &
  \correction{La taille de la roue et sa rotation.} \\
  %
  {\image{1}{images/mecanique/exemple_mouvement_0001} \\ Modèle d'humain} &
  Nombril &
  \correction{Curviligne.} &
...
\begin{doc}{Référentiel}
  ...
  \begin{importants}
    \important{Référentiel} : \texteTrou(1){
...
\begin{doc}{Opération sur les vecteurs}
