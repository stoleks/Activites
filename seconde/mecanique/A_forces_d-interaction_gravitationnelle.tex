...
\nomPrenomClasse
\titreActivite{Force d'interaction gravitationnelle}
...
\pasCorrection{
  \begin{tableauCompetences}
    ...
    REA & Calculer la valeur d'une force en faisant attention aux unités
...
\begin{doc}{Force d'interaction gravitationnelle}[\label{doc:interaction_gravitationnelle}]
  \fleche Tous les corps qui possèdent une masse s’attirent entre eux : c’est l’attraction gravitationnelle.
  \begin{importants}
...
%%%%
\documentaire Compléter le document \ref{doc:interaction_gravitationnelle}.
...
\separationBlocs{
  \centering
  \begin{tikzpicture}
    \tikzSchemaPlanete[orbite = 80pt, rayon = 60pt, satellite = H, centre = T, contour = couleurSec]
    % Distance d
  ...
  \centering
  \begin{tikzpicture}
    \tikzSchemaPlanete [orbite = 80pt, rayon = 73.22pt, satellite = H, centre = T, contour = couleurSec]
  \end{tikzpicture}
