...
\begin{doc}{Force et action mécanique}[\label{doc:action_force}]
  \begin{importants}  
    Un corps exerce une \important{action mécanique} sur un système étudié \texteTrou(1){s’il est capable d’en modifier le mouvement.}
  \end{importants}
...
%%
\begin{doc}{Exemples de forces}[\label{doc:exemples_forces}]
  ...
  \begin{listePoints}
    ...
    \item $\vv{f}$ représente l'action d'un milieu (gaz, liquide, support solide).
  \end{listePoints}
...
\begin{center}
  \begin{tblr}{
    ...
    Ballon & Parachutiste \\
    \image{1}{images/mecanique/exemple_force_0001} &
    \image{1}{images/mecanique/exemple_force_0002} \\
    %
    Cycliste & Skieuse \\
    \image{1}{images/mecanique/exemple_force_0003} &
    \image{1}{images/mecanique/exemple_force_0004} \\  
  \end{tblr}
\end{center}
