...
%%
\setcounter{documentNum}{1}
\begin{doc}{Vol d'oie et portance}
  \begin{center}
    \image{0.6}{images/exterieures/oie}
  \end{center}
...
%%
\setcounter{documentNum}{2}
\begin{doc}{Freinage d'un parachute à l'ouverture}
  \begin{wrapfigure}{r}{0.45\linewidth}
    \vspace*{-24pt}
    \begin{center}
      \image{1}{images/exterieures/donnees/norme_vitesse_parachute}
      \small{
