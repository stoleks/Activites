...
\newcommand{\ficheSecondeTP}[1]{
  ...
  \preambuleFicheTP{Seconde}{
    \evenement[creneau = 8, titre = TP 2GT2-1, lieu = A108]
    \evenement[creneau = 6, titre = TP 2GT4-2, jour = 2, lieu = A108];
    \evenement[creneau = 1, titre = TP 2GT4-1, jour = 5];
    \evenement[creneau = 6, titre = TP 2GT2-2, jour = 5];
  }
}
...
\newcommand{\fichePremiereStssTP}[1]{
  ...
  \preambuleFicheTP{Première ST2S}{
    \evenement[creneau = 2, titre = TP 1ST2S1-1, lieu = A103, couleur = purple-200]
    \evenement[creneau = 6, titre = TP 1ST2S1-2, lieu = A108, couleur = purple-200]
  }
}
...
\newcommand{\ficheTerminaleStssTP}[1]{
  ...
  \preambuleFicheTP{Terminale ST2S}{
    \evenement[creneau = 8, titre = TP TST2S-1, jour = 2, couleur = red-200]
    \evenement[creneau = 3, titre = TP TST2S-2, jour = 3, lieu = A103, couleur = red-200]
  }
}
