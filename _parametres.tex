...
%% Tableau
\usepackage{tabularx} % pour insérer des tableaux
\usepackage[table]{xcolor} % pour avoir des couleurs
\usepackage{multirow} % pour avoir des tableaux avec des cellules fusionnées
\usepackage{makecell} % pour régler le format des cellules d'un tableau
\usepackage{tabularray} % pour avoir de meilleurs tableaux [TO DO : retirer les autres paquets ?]
%% Math
...
%%%% Réglage pour avoir des cellules moins sérrée
