...
\usepackage{xspace} % pour avoir un espacement correct après certaines commandes
\usepackage{soul} % pour régler la couleur des soulignements
...
\hypersetup{
  ...
  filecolor=black, 
  urlcolor=couleurTer % lien internet
}
