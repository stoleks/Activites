...
\begin{enumerate}[label = \Alph*]
  \item Je planifie mon apprentissage, je coopère avec mes camarades et je fais valider les travaux réalisés.
  \item Je travaille à partir des documents et je sollicite régulièrement de l'aide pour avancer.
