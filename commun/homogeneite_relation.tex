...
\begin{doc}{Relation homogène}
  ...
  \begin{importants}
    L'homogénéité permet de \important{retrouver} la relation mathématique entre des grandeurs en regardant l'unité de la grandeur que l'on cherche à calculer.

    \begin{wrapfigure}{r}{0.25\linewidth}
      \vspace*{-20pt}
      \begin{equation*}
        M \left(\dfrac{\unit{\g}} {\unit{ \mole}}\right) 
        = \dfrac{m}{n} \dfrac{(\unit{\g})} {(\unit{\mole})}
      \end{equation*}
    \end{wrapfigure}
