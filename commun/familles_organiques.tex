\begin{doc}{Fonctions organiques}{doc:A_fonction_organique}
  ...
  \begin{center}
    \begin{tblr}{
      ...
      & \hspace{-24pt} \chemfig{!\vide{:-30} R_1 !\ch !\couleur C (!\cb R_2) (!\cchCouleur !\couleur O)}
      & \chemname[-12pt]{ \chemfig{-[1] (=[3,0.8]O) !\cb -[1]} }{ butan-2-one } \\
      %
      & {Aldéhyde \\ \phantom{B}}
      & \hspace{-24pt}\chemfig{!\vide{:-30} R_1 !\chCouleur !\couleur C (!\cchCouleur !\couleur O) !\cbCouleur !\couleur H} 
      & \chemname[-12pt]{ \chemfig{H-C (=[3,0.9]O) -H} }{ méthanal } \\
      %
      Carboxyle & Acide carboxylique
      & \hspace{-24pt} \chemfig{!\vide{:-30} R_1 !\ch !\couleur C (!\cchCouleur !\couleur O) !\cbCouleur !\couleur{OH}}
      & \chemname[1pt]{ \chemfig{-[-1] -[1] !\carboxyle} }{ acide propanoïque} \\
      %
      Ester & Ester
      & \hspace{-24pt} \chemfig{!\vide{:-30} R_1 !\ch !\couleur C (!\cchCouleur !\couleur O) !\cbCouleur !\couleur O !\ch R_2}
      & \chemname[1pt]{ \chemfig{-[-1] -[1] !\ester -[1] -[-1]} }{ propanoate d'éthyle} \\
      %
      {\phantom{B} \\ Éther-oxyde \\ \phantom{B}} & Éther
      & \hspace{-24pt} \chemfig{!\vide{:-30} R_1 !\chCouleur !\couleur O !\cbCouleur R_2}
      ...
      %
      Amide & Amide
      & \chemfig{[:-30] R_1 !\ch !\couleur C (!\cchCouleur !\couleur O) !\cbCouleur !\couleur N (!\ch R_3) !\cb R_2}
