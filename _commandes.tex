...
\newtcolorbox{activite}[3][]{
  before title = {\refstepcounter{activiteNum}},
  breakable, enhanced jigsaw, % pour s'étendre sur plusieurs pages
  colback = white, % fond blanc
  colframe = couleurPrim!25!black, % couleur de la boite
  coltitle = black, % couleur du titre
  ...
  colbacktitle = white, % fond pour le titre blanc
  fonttitle = \bfseries\sffamily,
  title = {\documentaire* Activité \arabic{section}.\arabic{activiteNum} -- #2\strut},
  remember as = #3,
  #1
}
\newcounter{TPNum}
\newtcolorbox{TP}[3][]{
  before title = {\refstepcounter{TPNum}},
  breakable, enhanced jigsaw, % pour s'étendre sur plusieurs pages
  colback = white, % fond blanc
  colframe = couleurPrim!25!black, % couleur de la boite
  coltitle = black, % couleur du titre
  ...
  colbacktitle = white, % fond pour le titre blanc
  fonttitle = \bfseries\sffamily,
  title = {\mesure* TP \arabic{section}.\arabic{TPNum} -- #2\strut},
  remember as = #3,
  #1
}
...
\NewDocumentCommand{\enTete}{o m o s}{
  % reset des compteurs
  \newpage
