%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% quelque couleurs
\definecolor{vertSombre} {RGB}{  0, 102,  26}
\definecolor{cyanSombre} {RGB}{  0, 140, 128}
\definecolor{jauneSombre}{RGB}{208, 173,   0}
\definecolor{jauneClair} {RGB}{238, 193,   0}
...
\newcommand{\correction}[1]{
  \vspace*{2pt}
  \hspace{16pt}
  \textcolor{couleurPrincipale!60!black}{
...
%%%% emphase
\newcommand{\emphase}[1]{
  \textcolor{couleurPrincipale}{\textsf{\bfseries \large #1}}
}
%
