...
\newcommand{\appreciation}[1]{
  \pasCorrection{
    \begin{boite}
      \vspace*{-4pt}
      \sousTitre[black]{Appréciation et remarques}
...
\newcommand{\exercice}[1]{
  ...
  \sousTitre[black]{\large Exercice \arabic{exerciceNum} : #1}
...
\newcommand{\titrePartie}[1]{
  ...
  \rectangle{40pt}{1pt}
  \sousTitre[black]{\Large \Roman{subsection} -- #1}
  \rectangle{40pt}{1pt}
  \vspace*{10pt}
}
...
\newcommand{\titreSection}[1]{
  ...
  \rectangle{30pt}{4pt}
  \sousTitre[black]{\large \arabic{subsubsection} -- #1}
  \vspace*{10pt}
}
\newcommand{\titreSousSection}[1]{
  \vspace*{12pt}
  \refstepcounter{sousSectionNum}
  \sousTitre[black]{\Alph{sousSectionNum} -- #1}
  \vspace*{8pt}
}
