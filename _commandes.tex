...
\colorlet{couleurPrim800}{cyan800}
\colorlet{couleurPrim300}{cyan300}
\colorlet{couleurPrim100}{cyan100}
\colorlet{couleurPrim50} {cyan50}

\colorlet{couleurSec}    {blue600}
\colorlet{couleurSec800} {blue800}
\colorlet{couleurSec300} {blue300}
\colorlet{couleurSec100} {blue100}
\colorlet{couleurSec50}  {blue50}

\colorlet{couleurTer}    {purple600}
\colorlet{couleurTer800} {purple800}
\colorlet{couleurTer300} {purple300}
\colorlet{couleurTer100} {purple100}
\colorlet{couleurTer50}  {purple50}

\colorlet{couleurQuat}   {red600}
\colorlet{couleurQuat800}{red800}
\colorlet{couleurQuat300}{red300}
\colorlet{couleurQuat100}{red100}
\colorlet{couleurQuat50} {red50}
...
\tcbset{
  ...
  titre sans separation/.style = {
    ...
    colframe = couleurSec800, % couleur de la boite
...
\newtcolorbox{importants}[1][]{
  boite cassable,
  boite pleine = couleurPrim50, % fond
...
\newenvironment{tableauCompetences}{
  \begin{center}
    \begin{tblr}{
      ...
      row{1} = {c, couleurSec100, font = \bfseries}
    }
      Comp. & Items & D & C & B & A \\
}{
    \end{tblr}
...
\newcommand*\nombreCercle[1]{
  ...
  %   \node [shape=circle, draw filled, inner sep=1.2pt, color=couleurSec50] (char) {\textcolor{black}{#1};
  % }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% points importants
\NewDocumentCommand{\important}{O{couleurSec800} +m}{
...
\lstdefinestyle{codePython}{
  commentstyle=\color{magenta500},
  keywordstyle=\color{green500},
  stringstyle =\color{purple500},
