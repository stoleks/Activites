...
\newcommand\rectangleCyan[2]{
  \rectangle{couleurPrincipale}{#1}{#2}
}
...
\newtcolorbox{doc}[3][]{
  ...
  colframe = couleurPrincipale!25!black, % couleur de la boite
...
\newtcolorbox{encart}[1][]{
  ...
  colback = white!95!couleurPrincipale, % fond
  borderline west={4pt}{0pt}{couleurPrincipale}, % barre gauche
  #1
}
...
\newtcolorbox{contexte}[1][]{
  ...
  colframe = couleurPrincipale, % couleur des contours
  colback = white!95!couleurPrincipale, % fond
  #1
}
...
\newtcolorbox{boiteObjectifs}[2][]{
  ...
  frame code = { % tracé de la boite
    ...
    \path [draw=couleurPrincipale, line width = 3pt]
...
\newcommand{\numeroQuestion}{
  ...
  \textcolor{\couleurExercice}{%couleurPrincipale!75!black}{
    \textbf{\arabic{questionNum}} {\small\faMinus}
  }
}
...
\newcounter{qcmNum}
\newcommand{\QCM}[2]{
  \refstepcounter{qcmNum}
  \vspace*{2pt}
  \textcolor{couleurPrincipale!75!black}{
    \textbf{\arabic{qcmNum}} {\small\faMinus}
  } #1
