...
\newenvironment{tableauMemorisation}{
 ...
 \begin{tblr}{
    colspec = {
      Q[l, wd=0.3\textwidth] X[c] X[c] Q[l, wd=0.3\textwidth] 
      Q[c, wd=0.045\textwidth] Q[c, wd=0.045\textwidth] Q[c, wd=0.045\textwidth]
    }, rows = {m}, hlines, vlines,
...
%%%% jeu de données, avec une * pour que ça soit sur deux colonnes
\NewDocumentEnvironment{donnees}{s +m}{  
  \important{Données :}
  \IfBooleanTF{#1}{
    \vspace*{-8pt}
    \begin{multicols}{2}
