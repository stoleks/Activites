...
\question{
  ...
  \end{equation*}
  où $c_\text{eau} = 4,\!180 \unit{J \cdot g^{-1} \cdot \degree C^{-1}}$ est la capacité calorifique de l'eau.
...
On voit que pour fondre, les glaçons ont dû recevoir de l'énergie sous forme de transfert \\[8pt]
thermique par l'eau liquide autour d'eux. 
On parle de \reponseLigne
\reponse{1}
