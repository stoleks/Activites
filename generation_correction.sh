...
pdflatex -fmt=preambule.fmt -interaction=nonstopmode -draftmode main.tex > out/log_$2.out
pdflatex -fmt=preambule.fmt -interaction=nonstopmode main.tex > out/log_$2.out
