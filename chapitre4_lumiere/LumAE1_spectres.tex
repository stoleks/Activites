...
\begin{doc}{Émission atomique ou moléculaire}
  ...
  \begin{encart}
    ...
    sont excitées, elles émettent seulement \texteTrouMultiLignes{des radiations avec des longueurs d'ondes précises}{1}
    
    Cela correspond à \texteTrouLigneComplete{des raies bien définies.}
  \end{encart}
